...
const teamsAdmin: FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSubmissionState({
                ...
                success: true,
                error: null,
                message: `Member request  ${editingMember ? 'updated' : 'created'} successfully!.`,
                fieldErrors: {}
            });
            ...
            setSubmissionState({
                loading: false,
                success: false,
                error: `Falied to ${editingMember ? 'update' : 'create'} member.`,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Members" />
            <div className="min-h-screen bg-gray-100 text-black md:px-6 py-8 p-4">
                <div className="">
                    <div className="mb-4 sm:mb-0 sticky top-20 mb-2">
                        ...
                        <p className="mt-1 text-sm text-gray-500 dar:text-gray-400">
                            Manage all available members in your system.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
                            ...
                            <form onSubmit={handleSubmit} encType=''>
                                ...
                                <div className="mb-2">
                                    ...
                                    {submissionState.fieldErrors?.bio && (
                                        <p className="mt-1 text-sm text-red-600">{submissionState.fieldErrors.bio[0]}</p>
                                    )}
                                </div>
                                ...
                                <div className="mb-2">
                                    ...
                                    {submissionState.fieldErrors?.image_url && (
                                        <p className="mt-1 text-sm text-red-600">{submissionState.fieldErrors.image_url[0]}</p>
                                    )}
                                </div>
                        ...
                        {/* teams List */}
                        <div className="bg-white rounded-lg shadow-md p-6 mt-2 lg:col-span-2">
                            <h2 className="text-xl font-semibold mb-4">Current Members</h2>

                            {teams.length === 0 ? (
                                <p className="text-gray-500">No members available. Add your first member above.</p>
                            ) : (
