            ...
            <div className="px-4 py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between mb-8">
                    <div className="mb-4 sm:mb-0">
                        <h1 className="text-2xl font-bold text-gray-900 dar:text-white">Departments Management</h1>
                        <p className="mt-1 text-sm text-gray-500 dar:text-gray-400">
                            Manage all available departments in your system
                        </p>
                    </div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200 dar:divide-gray-700">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200 ">
                                {departments.map((department, index) => (
                                    <tr key={department.id} className="hover:bg-gray-50 dar:hover:bg-gray-700/50">
